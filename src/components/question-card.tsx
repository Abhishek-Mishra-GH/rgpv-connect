    ...
    <Card className="hover:border-primary/50 transition-all duration-200">
      <CardContent className="p-4">
        <div className="flex flex-col sm:flex-row sm:gap-4">
          ...
          <div className="hidden sm:flex flex-col items-center gap-1 text-muted-foreground w-12">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground text-sm mt-2 line-clamp-2">{question.summary}</p>
            ...
            <div className="flex flex-wrap items-center justify-between mt-4 gap-y-2">
              ...
              <div className="flex sm:hidden items-center gap-4">
                 <div className="flex items-center gap-1 text-muted-foreground">
                    <form action={handleUpvote} className="flex items-center">
                        <VoteButton type="up" />
                    </form>
                    <span className="text-sm font-bold text-foreground min-w-[12px] text-center">{question.upvotes}</span>
                     <form action={handleDownvote} className="flex items-center">
                        <VoteButton type="down" />
                    </form>
                </div>
